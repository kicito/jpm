...
_See code: [src/commands/init.ts](https://github.com/jolie/jpm/blob/v3.0.2/src/commands/init.ts)_
...
_See code: [src/commands/install.ts](https://github.com/jolie/jpm/blob/v3.0.2/src/commands/install.ts)_
...
_See code: [src/commands/remove.ts](https://github.com/jolie/jpm/blob/v3.0.2/src/commands/remove.ts)_
<!-- commandsstop -->
