...
running command...
$ jpm (--version)
@jolie/jpm/1.0.4 linux-x64 node-v16.15.0
$ jpm --help [COMMAND]
USAGE
  $ jpm COMMAND
...
...
_See code: [dist/commands/init.ts](https://github.com/jolie/jpm/blob/v1.0.4/dist/commands/init.ts)_
...
_See code: [dist/commands/install.ts](https://github.com/jolie/jpm/blob/v1.0.4/dist/commands/install.ts)_
...
_See code: [dist/commands/remove.ts](https://github.com/jolie/jpm/blob/v1.0.4/dist/commands/remove.ts)_
<!-- commandsstop -->
